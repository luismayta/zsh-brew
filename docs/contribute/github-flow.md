<!-- Space: Projects -->
<!-- Parent: ZshBrew -->
<!-- Title: Contributing GithubFlow ZshBrew -->
<!-- Label: ZshBrew -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-brew project on [GitHub](https://github.com/luismayta/zsh-brew), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-brew/pulls).
...
To follow the instructions in this guide and start contributing to zsh-brew project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-brew.git
```

Now your **upstream** points to **luismayta/zsh-brew**.
...
git fetch upstream # assuming upstream is luismayta/zsh-brew
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-brew/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
